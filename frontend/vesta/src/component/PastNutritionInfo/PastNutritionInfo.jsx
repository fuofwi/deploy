...
class PastNutritionInfo extends Component {
  ...
  render() {
    ...
    if (this.props.currUserNutrition && this.props.currUser) {
      ...
      const recommendedCarbs = Calculator.recommendedCarbs(recommendedCalorie);
      const recommendedProtein = Calculator.recommendedProtein(recommendedCalorie);
      const recommendedFat = Calculator.recommendedFat(recommendedCalorie);
